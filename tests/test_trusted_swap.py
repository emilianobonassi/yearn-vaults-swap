...
def test_swap_v1_not_registered_vault(vaultFactory, vaultFactoryV1, controllerFactoryV1, Token, StrategyDForceDAI, user, TrustedVaultSwap, gov, accounts):
    # Registry
...
def test_swap_v1_registered_vault(interface, vaultFactoryV1, controllerFactoryV1, Token, StrategyDForceDAI, user, TrustedVaultSwap, gov, accounts):
    # Registry
    registry = "0xe15461b18ee31b7379019dc523231c57d1cbc18c"
    vaultSwap = gov.deploy(TrustedVaultSwap, registry)
